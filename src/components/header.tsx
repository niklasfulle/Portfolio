...
export default function Header() {
  ...
  return (
    <header className="relative">
      ...
      <div className="absolute left-1/2 top-[-11rem] -z-20 h-[41.25rem] w-[31.25rem] translate-x-[35%] rounded-full bg-[#5bb0ff] blur-[16rem] dark:bg-[#637494] sm:w-[68.75rem]"></div>
      <motion.div
