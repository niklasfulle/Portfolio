  ...
  de: {
    privacy: {
      ...
      sections: [
        ...
        ["Browser-Speicher und Cookies", "Für die Theme-Auswahl verwendet die Seite nach deiner ausdrücklichen Zustimmung lokalen Browser-Speicher. Die Einwilligungsentscheidung selbst wird für 180 Tage gespeichert. Analyse- und Marketingdienste werden im geprüften Code nicht eingesetzt."],
    ...
    cookies: {
      ...
      sections: [
        ...
        ["Theme-Präferenz", "Die Theme-Auswahl wird erst nach ausdrücklicher Zustimmung im Browser gespeichert. Bei Ablehnung bleibt die Seite im hellen Design und es wird keine Theme-Präferenz abgelegt."],
  ...
  en: {
    privacy: {
      ...
      sections: [
        ...
        ["Browser storage and cookies", "The site uses browser storage for the theme choice only after your explicit consent. The consent decision itself is stored for 180 days. No analytics or marketing services are used in the reviewed code."],
    ...
    cookies: {
      ...
      sections: [
        ...
        ["Theme preference", "The selected theme is stored in the browser only after explicit consent. If rejected, the site stays in the light theme and no theme preference is stored."],
